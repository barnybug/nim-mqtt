...
when not defined(MQTTCLIENT_H): 
  ...
  # 
  type 
    MQTTClient_deliveryToken* = cint
    MQTTClient_token* = cint
  #*
  ...
  # 
  type 
    MQTTClient_message* = object 
      struct_id*: array[4, char] #* The eyecatcher for this structure.  must be MQTM. 
      #* The version number of this structure.  Must be 0 
      struct_version*: cint   #* The length of the MQTT message payload in bytes. 
      payloadlen*: cint       #* A pointer to the payload of the MQTT message. 
      payload*: pointer #* 
      ...
      retained*: cint #* 
                      ...
                      #       duplicate message.
                      #      
      dup*: cint #* The message identifier is normally reserved for internal use by the
  ...
  # 
  type 
    MQTTClient_messageArrived* = proc (context: pointer; topicName: cstring; 
                                       topicLen: cint; 
                                       message: ptr MQTTClient_message): cint {.
        cdecl.}
  #*
  #  This is a callback function. The client application
  #  must provide an implementation of this function to enable asynchronous 
  ...
  # 
  type 
    MQTTClient_deliveryComplete* = proc (context: pointer; 
        dt: MQTTClient_deliveryToken) {.cdecl.}
  #*
  #  This is a callback function. The client application
  #  must provide an implementation of this function to enable asynchronous 
  ...
  # 
  type 
    MQTTClient_connectionLost* = proc (context: pointer; cause: cstring) {.cdecl.}
  #*
  ...
  # 
  type 
    MQTTClient_willOptions* = object 
      struct_id*: array[4, char] #* The eyecatcher for this structure.  must be MQTW. 
      #* The version number of this structure.  Must be 0 
      struct_version*: cint   #* The LWT topic to which the LWT message will be published. 
      topicName*: cstring     #* The LWT payload. 
      message*: cstring #*
  ...
  #
  type 
    MQTTClient_SSLOptions* = object 
      struct_id*: array[4, char] #* The eyecatcher for this structure.  Must be MQTS 
      #* The version number of this structure.  Must be 0 
      struct_version*: cint   #* The file in PEM format containing the public digital certificates trusted by the client. 
      trustStore*: cstring #* The file in PEM format containing the public certificate chain of the client. It may also include
                           #  the client's private key. 
                           # 
      keyStore*: cstring #* If not included in the sslKeyStore, this setting points to the file in PEM format containing
                         #  the client's private key.
                         # 
      privateKey*: cstring    #* The password to load the client's privateKey if encrypted. 
      privateKeyPassword*: cstring #*
                                   ...
                                   # 
      enabledCipherSuites*: cstring #* True/False option to enable verification of the server certificate *
      enableServerCertAuth*: cint
  ...
  type 
    MQTTClient_connectOptions* = object 
      struct_id*: array[4, char] #* The eyecatcher for this structure.  must be MQTC. 
      ...
      #  
      struct_version*: cint #* The "keep alive" interval, measured in seconds, defines the maximum time
      ...
      reliable*: cint #* 
                      ...
                      #   
      will*: ptr MQTTClient_willOptions #* 
